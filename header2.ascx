      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
           <i class="bi bi-grid-3x3-gap text-white"></i> <asp:Label ID="lbUser" runat="server"></asp:Label>
          </a>
   ...
   <%End if %>
      ...
      <span class="navbar-text">
        ...
        <span class="badge rounded-pill bg-light text-primary">      
            ...
            <i class="bi bi-wifi-2"></i> <asp:Label ID="lbUseronline" runat="server"></asp:Label></span>
    </span>
  </div>
</nav>
<!--End NAV bar -->
