...
<%@ Page Language="VB" ContentType="text/html" %>
  ...
  <script runat="server">
      ...
      Private Sub BindData(Optional ByVal searchPartyname As String = Nothing, Optional ByVal searchPartyset As String = Nothing)
          ...
          strSQL = "SELECT *"
          strSQL = strSQL & " FROM"
          strSQL = strSQL & " political_party"
          strSQL = strSQL & " where enable='T' "
          If Not String.IsNullOrEmpty(searchPartyname) Then
              strSQL = strSQL & " and political_partyname like '%" & searchPartyname & "%' "
          End If
          If Not String.IsNullOrEmpty(searchPartyset) Then
              strSQL = strSQL & " and partyset = '" & searchPartyset & "' "
          End If
      ...
      Sub modDeleteCommand(ByVal sender As Object, ByVal e As EventArgs)
          Dim partyID As String = (TryCast(sender, Button)).CommandArgument
          ...
          strSQL = "update political_party set enable='F' WHERE ID = '" & partyID & "'"
      ...
      Sub newuser()
          ...
          strSQL = "insert into political_party (political_partyname, partyset, create_by, create_date, enable) values ("
          strSQL = strSQL & "'" & Request.Form("partyname1") & "', "
          strSQL = strSQL & "'" & Request.Form("partyset1") & "', "
      ...
      Sub UpdateData()
          ...
          strSQL = "UPDATE political_party SET"
          strSQL = strSQL & " political_partyname = '" & Request.Form("partyname") & "'"
          strSQL = strSQL & ", partyset = '" & Request.Form("partyset") & "'"
      ...
      Protected Sub OnPreview(ByVal sender As Object, ByVal e As EventArgs)
          ...
          strSQL = "SELECT * from political_party where id='" & partyID & "'"

          dtAdapter = New MySqlDataAdapter(strSQL, objConn)
          dtAdapter.Fill(dt)

          id.Text = dt.Rows(0)("id").ToString
          partyname.Text = dt.Rows(0)("political_partyname").ToString
          partyset.Text = dt.Rows(0)("partyset").ToString
      ...
      Protected Sub Search(ByVal sender As Object, ByVal e As EventArgs)
          BindData(partyname3.Text, partyset3.Text)
      End Sub
 ...
 <div class="progress" id="progressbar1" >
  <div class="progress-bar progress-bar-striped progress-bar-animated"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%"></div>
    ...
    <div class="col-lg-3 col-sm-12">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <div class="card">
  <h5 class="card-header bg-info text-white">รายชื่อพรรคการเมือง</h5>
  <div class="card-body">
        ...
        <ContentTemplate>
            ...
            <div class="alert alert-primary" role="alert">
                <div class="row">
                    <div class="col">
                        <label for="partyname3">ชื่อพรรคการเมือง:</label>
                      <asp:TextBox ID="partyname3" runat="server" placeholder="" CssClass="form-control"/>
                        </div>
                    <div class="col">
                         <label for="partyset3">รัฐบาลชุดที่:</label>
                      <asp:TextBox ID="partyset3" runat="server" placeholder="" CssClass="form-control"/>
                        </div>
                    </div>
	...
	<asp:TemplateField HeaderText="ชื่อพรรคการเมือง" HeaderStyle-CssClass="bg-info text-white text-center" ItemStyle-CssClass="text-left">
		<ItemTemplate>
			<asp:Label id="lbPartyName" runat="server" Text='<%# Eval("political_partyname") %>'></asp:Label>
		</ItemTemplate>
	</asp:TemplateField>

        <asp:TemplateField HeaderText="รัฐบาลชุดที่" HeaderStyle-CssClass="bg-info text-white text-center" ItemStyle-CssClass="text-center">
		<ItemTemplate>
			<asp:Label id="lbpartyset" runat="server" Text='<%# Eval("partyset") %>'></asp:Label>&nbsp;
		</ItemTemplate>
	</asp:TemplateField>
  ...
  <div class="modal-dialog modal-md modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-header bg-info"><h3>แก้ไขข้อมูลพรรคการเมือง</h3>
            ...
            <div class="row">
             <div class="col">
                 ...
                 <asp:TextBox ID="id" runat="server" CssClass="form-control" />
                  ...
                  <label for="partyname">ชื่อพรรคการเมือง:</label>
                  <asp:TextBox ID="partyname" runat="server" placeholder="" CssClass="form-control"/>
                  <asp:RequiredFieldValidator ID="Vpartyname" runat="server" ControlToValidate="partyname" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v2"></asp:RequiredFieldValidator>
              </div>

                  <div class="col">
                  <label for="partyset">รัฐบาลชุดที่:</label>
                  <asp:TextBox ID="partyset" runat="server" placeholder="" CssClass="form-control" />
                  <asp:RequiredFieldValidator ID="Vpartyset" runat="server" ControlToValidate="partyset" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v2"></asp:RequiredFieldValidator>
                  </div>
            </div>
  ...
  <div class="modal-dialog modal-md modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <ContentTemplate>
      <div class="modal-header bg-primary"><h3>เพิ่มข้อมูลพรรคการเมือง</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                  <label for="partyname1">ชื่อพรรคการเมือง:</label>
                  <asp:TextBox ID="partyname1" runat="server" placeholder="" CssClass="form-control"/>
                  <asp:RequiredFieldValidator ID="Vpartyname1" runat="server" ControlToValidate="partyname1" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v1"></asp:RequiredFieldValidator>
                     </div>

                  <div class="col">
                  <label for="partyset1">รัฐบาลชุดที่:</label>
                  <asp:TextBox ID="partyset1" runat="server" placeholder="" CssClass="form-control" />
                  <asp:RequiredFieldValidator ID="Vpartyset1" runat="server" ControlToValidate="partyset1" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v1"></asp:RequiredFieldValidator>
                  </div>
            </div>
