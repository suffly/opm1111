...
<%@ Page Language="VB" ContentType="text/html" %>
  ...
  <script runat="server">
      ...
      Private Sub BindData()
          ...
          strSQL = strSQL & " order by channel_name"
      ...
      Sub modDeleteCommand(ByVal sender As Object, ByVal e As EventArgs)
          Dim channelID As String = (TryCast(sender, Button)).CommandArgument
          ...
          strSQL = "update channel set enable='F' WHERE ID = '" & channelID & "'"
      ...
      Sub newuser()
          ...
          strSQL = "insert into channel (channel_name, create_by, create_date, enable) values ("
          strSQL = strSQL & "'" & Request.Form("channel_name1") & "', "
      ...
      Sub UpdateData()
          ...
          strSQL = strSQL & " channel_name = '" & Request.Form("channel_name") & "'"
      ...
      Protected Sub OnPreview(ByVal sender As Object, ByVal e As EventArgs)
          ...
          strSQL = "SELECT * from channel where id='" & channelID & "'"

          dtAdapter = New MySqlDataAdapter(strSQL, objConn)
          dtAdapter.Fill(dt)

          id.Text = dt.Rows(0)("id").ToString
          channel_name.Text = dt.Rows(0)("channel_name").ToString
 ...
 <div class="progress" id="progressbar1" >
  <div class="progress-bar progress-bar-striped progress-bar-animated"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%"></div>
    ...
    <div class="col-lg-3 col-sm-12">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <div class="card">
  <h5 class="card-header bg-info text-white">ช่องทางการรับเรื่อง</h5>
  <div class="card-body">
	...
	<asp:TemplateField HeaderText="ชื่อช่องทางการรับเรื่อง" HeaderStyle-CssClass="bg-info text-white text-center" ItemStyle-CssClass="text-left">
		<ItemTemplate>
  ...
  <div class="modal-dialog modal-md modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-header bg-info"><h3>แก้ไขข้อมูลช่องทางการรับเรื่อง</h3>
            ...
            <div class="row">
             <div class="col">
                 ...
                 <asp:TextBox ID="id" runat="server" CssClass="form-control" />
                  ...
                  <label for="channel_name">ชื่อช่องทางการรับเรื่อง:</label>
                  <asp:TextBox ID="channel_name" runat="server" placeholder="" CssClass="form-control"/>
                  <asp:RequiredFieldValidator ID="Vchannel_name" runat="server" ControlToValidate="channel_name" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v2"></asp:RequiredFieldValidator>
              </div>
  ...
  <div class="modal-dialog modal-md modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <ContentTemplate>
      <div class="modal-header bg-primary"><h3>เพิ่มข้อมูลช่องทางการรับเรื่อง</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                  <label for="channel_name1">ชื่อช่องทางการรับเรื่อง:</label>
                  <asp:TextBox ID="channel_name1" runat="server" placeholder="" CssClass="form-control"/>
                  <asp:RequiredFieldValidator ID="Vchannel_name1" runat="server" ControlToValidate="channel_name1" ErrorMessage="โปรดระบุ" Display="Dynamic" ForeColor="#FF0000" ValidationGroup="v1"></asp:RequiredFieldValidator>
                     </div>
            </div>
