...
Public Class casestatus1
    ...
    Private Sub BindData()
        ...
        strSQL = "SELECT *"
        strSQL = strSQL & " FROM"
        strSQL = strSQL & " case_status"
        strSQL = strSQL & " where enable='T' "
        strSQL = strSQL & " order by status_name"
    ...
    Sub modDeleteCommand(ByVal sender As Object, ByVal e As EventArgs)
        Dim casestatusID As String = (TryCast(sender, Button)).CommandArgument
        ...
        strSQL = "update case_status set enable='F' WHERE ID = '" & casestatusID & "'"
    ...
    Sub newuser()
        ...
        strSQL = "insert into case_status (status_name, create_by, create_date, enable) values ("
        strSQL = strSQL & "'" & Request.Form("statusname1") & "', "
    ...
    Sub UpdateData()
        ...
        strSQL = strSQL & " status_name = '" & Request.Form("statusname") & "'"
    ...
    Protected Sub OnPreview(ByVal sender As Object, ByVal e As EventArgs)
        ...
        strSQL = "SELECT * from case_status where id='" & casestatusID & "'"

        dtAdapter = New MySqlDataAdapter(strSQL, objConn)
        dtAdapter.Fill(dt)

        id.Text = dt.Rows(0)("id").ToString
        statusname.Text = dt.Rows(0)("status_name").ToString
