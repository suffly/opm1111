...
<script runat="server">
    ...
    Sub BindData()
        ...
        strSQL = strSQL & " province.NAME_TH as province,"
        strSQL = strSQL & " count(case_inbox.case_id) as total"
        strSQL = strSQL & " FROM"
        strSQL = strSQL & " case_inbox"
        strSQL = strSQL & " LEFT OUTER JOIN province ON case_inbox.case_province = province.ID"
        ...
        End If
        strSQL = strSQL & " group by createDate, province "
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%"></div>
    ...
    <!-- Content-->         
     ...
     <div class="d-flex justify-content-between">
            <h2><i class="bi bi-journal-text"></i> 3. รายงานตามพื้นที่ของปัญหา</h2>
                </div>
  </div>
  <div class="card-body">
      ...
      <asp:GridView ID="gridview1" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-sm">
          <Columns>
              ...
              <asp:TemplateField HeaderText="วันที่บันทึกข้อมูล"  HeaderStyle-CssClass="bg-success text-white text-center">
                ...
                <asp:TemplateField HeaderText="พื้นที่ปัญหา"  HeaderStyle-CssClass="bg-success text-white text-center">
                  <ItemTemplate>
